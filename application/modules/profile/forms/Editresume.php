...
class Profile_Form_Editresume extends Zend_Form
{
	public $args;
	...
	public function init()
    {
    	...
    	if(isset($this->args[1][0])){
    		...
    		if(isset($args->type)){
    			...
    			$resume = $args->experience;
    			$about 	= $args->special_skills;
    			$id 	= $args->talentnum;
    			//echo'<pre>'; print_r($this->args[1][0]); exit;
    		}
    	}

		$text = new Zend_Form_Element_Textarea('edit_resume');
		$text->setValue($resume);
    	...
    	$submit = new Zend_Form_Element_Submit('edit_resumes');
